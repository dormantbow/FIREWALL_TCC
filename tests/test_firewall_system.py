...
# Carregar o módulo de teste dinamicamente
spec = importlib.util.spec_from_file_location("test_firewall_system", 
                                             "tests/test_firewall_system.py")
test_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(test_module)

# O módulo será executado automaticamente se tiver um bloco if __name__ == "__main__"
